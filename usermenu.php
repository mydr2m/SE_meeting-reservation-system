...
<nav class="navbar navbar-expand-lg navbar-Dark" style="background-color: #ffe595;">
    <div class="container">
        ...
        <a class="navbar-brand" href="calendar-u.php" style="color:black">ระบบจองห้องประชุม</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item ">
                    <a class="nav-link" href="calendar-u.php" style="color:black">
                        ปฏิทินการประชุม
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="addmeet-u.php" style="color:black">
                        จองห้องประชุม
                    </a>
                </li>
            </ul>
